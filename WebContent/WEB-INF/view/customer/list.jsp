...
$('.page1').click(function(){
	location.assign('customer.do?employee_id=1000&employee_name=SULMIN&cmd=access&dir=customer&page=list#');
});

$('.page2').click(function(){
	location.assign('customer.do?employee_id=1000&employee_name=SULMIN&cmd=list&page=list&page_num=2&page_size=5');
});
